  ...
  theme: {
    ...
    extend: {
      boxShadow: {
        ...
        "custom-input": "4px 4px white,  -4px 4px white",
      },
      backgroundImage: {
        homeBg: "url('/devImages/man-with-medical-problems.jpg')",
        heroBg: "url('/devImages/OIP.jpeg')",
        hero2: "url('/devImages/pattern.jpg')",
        hero3: "url('/devImages/hero.webp')",
        hero4: "url('/devImages/woman.jpg')",
      },
      colors: {
