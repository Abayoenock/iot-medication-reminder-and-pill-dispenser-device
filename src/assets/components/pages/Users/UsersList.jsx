...
const UserList = () => {
  ...
  const columns = [
    ...
    {
      name: "role",
      selector: (row) => (row["role"] == 1 ? "Client" : "admin"),
    },
        ...
        <div className="w-full mt-3 px-8">
          ...
          >
            ...
            <DialogActions>
              ...
              <button
                onClick={deleteUser}
                className="border-none bg-cyan-700 p-2 px-3 text-white text-sm font-semibold rounded-sm transition-all duration-300 hover:bg-cyan-800 "
              >
                Confirm
              </button>
            </DialogActions>
