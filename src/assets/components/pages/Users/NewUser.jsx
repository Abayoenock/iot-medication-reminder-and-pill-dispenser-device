  ...
  return (
    <div className="  px-6 p-4 w-full flex flex-col ">
      <div className=" w-fit">
        <NavLink to="../">
          {" "}
          <button className=" bg-cyan-700 p-2 px-3 text-white text-sm rounded-sm transition-all duration-300 hover:-translate-x-1 hover:bg-cyan-800">
            {" "}
            <FontAwesomeIcon
              icon={faAnglesLeft}
            ...
            <div className="flex mb-4 w-fit bg-white absolute left-4 -top-[90px] ">
              {!selectedImage && (
                ...
                >
                  ...
                  />
                  <p className="text-xs  text-cyan-700 absolute bottom-2 ">
              ...
              <input
                ...
                className="border border-cyan-700 px-2 py-1 hidden"
                ref={fileInputRef}
                name="driverImage"
              />
            </div>
                ...
                <div className=" w-full  grid grid-cols-2 gap-x-8 gap-y-3 px-4">
                  <div className="relative z-0 mb-6 w-full group">
                    <input
                      ...
                      name="firstName"
                      id="firstName"
                      className="block py-2.5 px-0 w-full text-sm text-cyan-900 bg-transparent border-0 border-b-2 border-cyan-700 appearance-none focus:outline-none focus:ring-0 focus:border-cyan-900 peer"
                      placeholder=" "
                      required
                    />
                    <label
                      htmlFor="firstName"
                      className="absolute text-sm text-cyan-900  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-purple-950  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >
                      first name
                    </label>
                  </div>
                  ...
                  <div className="relative z-0 mb-6 w-full flex group items-end ">
                    <select
                      className="block w-full text-cyan-900   px-0  text-sm  bg-transparent border-b-2 pb-2 border-cyan-700 focus:outline-none focus:ring-0 focus:border-cyan-900 peer"
                      id=""
                      name="category"
                    >
