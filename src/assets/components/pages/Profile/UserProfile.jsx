...
function UserProfile({ myCallBack }) {
  ...
  return (
    <>
      ...
      <div className=" container mx-auto px-2 flex  relative w-full  mt-2 outline-4 justify-center">
        <button
          className=" absolute top-2 right-6 bg-cyan-700 p-2 px-3 text-white text-sm rounded-sm transition-all duration-300 hover:translate-x-1 hover:bg-cyan-900"
          onClick={handleClick}
        >
          <FontAwesomeIcon icon={faKey} className="mr-2" /> Change password
        </button>
        <div className=" mt-[90px] w-full md:w-[60%] relative flex flex-col p-2 gap-4 justify-center items-center border-[1px] border-dotted border-cyan-300 ">
          <form
            method="post"
            id="profileForm"
          ...
          >
            <div className="w-fit  absolute left-4 -top-[75px]">
              <div className="flex mb-4 w-fit  ">
                {!selectedImage && (
                  <label
                    htmlFor="image"
                    className=" cursor-pointer transition-all duration-300 hover:bg-cyan-100 relative mr-2 w-[150px] h-[150px] border-[1px] border-dashed border-cyan-200 flex items-center justify-center flex-col"
                  >
                    {" "}
                    <ImageWithBlurhash
                      imageUrl={
                    ...
                    />
                    <p className=" text-xs p-2 w-full  text-white absolute  bottom-0  left-0  bg-cyan-700 bg-opacity-50 backdrop-blur-sm h-fit transition-all duration-300 group-hover:-translate-y-[100%]  ">
                ...
                {selectedImage && (
                  <div className=" relative w-[150px] h-fit border-[1px] border-dashed border-cyan-200 p-4 py-2">
            ...
            <div className=" w-full grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-[150px]">
              <div className="relative z-0 mb-6 w-full group">
                ...
                <label
                  htmlFor="firstName"
                  className="absolute text-sm text-gray-500  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-cyan-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Firstname
                </label>
              </div>
              ...
              <div className="w-full flex justify-end col-span-2 ">
                <button
                  ...
                  }  focus:ring-4 focus:ring-cyan-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center  `}
                >
                  {!isSubmit ? (
                    "Update"
                  ) : (
      ...
      >
        <form
          ...
          className=" relative w-[80%] md:w-1/2  p-4 shadow-lg rounded-md border-[1px] border-cyan-100 py-8 bg-white   "
        >
          <FontAwesomeIcon
            icon={faXmark}
          ...
          <div className="w-full flex justify-end ">
            <button
              type="submit"
              className="  text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:ring-cyan-300 font-medium rounded-lg text-sm w-fit sm:w-auto px-5 py-2.5 text-center d"
            >
              Update
            </button>
          </div>
